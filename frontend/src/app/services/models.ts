...
export { CompRequest } from './models/comp-request';
export { CompResponse } from './models/comp-response';
...
export { PageResponseCompResponse } from './models/page-response-comp-response';
